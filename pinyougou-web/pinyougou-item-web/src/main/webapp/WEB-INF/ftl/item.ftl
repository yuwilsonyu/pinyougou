							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										...
										<a href="#" target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addToCart();">{{sku.id}}加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="tab-main intro">
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<#assign customerAttributeList = goodsDesc.customAttributeItems?eval/>
								<ul class="goods-intro unstyled">
									<#list customerAttributeList as item>
									    <#if item??>
